...
SHIRT: They are wearing a short-sleeve WHITE football jersey (like a standard FIFA World Cup match shirt). It is NOT a kaftan or traditional garment — it is a modern athletic football shirt with a regular fit, short sleeves, and a V-neck collar. The shirt design: white fabric across the entire body and sleeves. On the chest and torso, there are broad vertical panels (roughly half the shirt width) filled with a repeating gold/yellow geometric zellige mosaic pattern — small interlocking diamonds and cross shapes, like traditional Moroccan tile decoration. The gold pattern panels are wide, covering most of the front. The V-neck collar has three stripes: red on the outside, green in the middle, white on the inside. Short white sleeves. NO brand logo. NO federation badge. NO Puma cat. NO crest. NO text. Just the white jersey with the wide gold zellige pattern.
