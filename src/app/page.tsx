              ...
              <div style={{ marginTop: "16px", display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <button onClick={async () => {
                  ...
                  try {
                    ...
                    const file = new File([blob], "morocco-2026-legend.jpg", { type: blob.type });
                ...
                <a href={resultUrl} download="morocco-2026-legend.jpg" style={{
                  background: C.red, borderRadius: "8px", color: "#fff",
                  padding: "12px 24px", fontSize: "14px", fontWeight: 700,
                  letterSpacing: "0.5px", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "8px",
                }}>⬇ Download</a>
